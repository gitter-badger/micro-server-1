...
//            GlobalVariableService.setRepositoryEnvironmentVariable(varActionMap);
    ...
    public static MicroRepositoryBean parser(MicroRepositoryBean microRepository, String ymlPath) throws IOException {
        return MicroRepositoryFactory.parser(microRepository, ymlPath);
    }

    public static MicroModule parserOLD(String ymlPath) throws IOException {
